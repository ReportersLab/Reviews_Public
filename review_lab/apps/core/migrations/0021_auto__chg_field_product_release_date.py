...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_product', 'release_date', self.gf('django.db.models.fields.CharField')(default='', null=True, max_length=64))


    def backwards(self, orm):
        
        # Changing field 'Product.release_date'
        db.alter_column('core_product', 'release_date', self.gf('django.db.models.fields.DateField')(null=True))
