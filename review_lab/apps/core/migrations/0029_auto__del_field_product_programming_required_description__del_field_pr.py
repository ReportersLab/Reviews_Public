...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.programming_required_description'
        db.delete_column('core_product', 'programming_required_description')

        # Deleting field 'Product.programming_required_rating'
        db.delete_column('core_product', 'programming_required_rating')

        # Adding field 'Review.programming'
        db.add_column('core_review', 'programming', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Review.programming_text'
        db.add_column('core_review', 'programming_text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Product.programming_required_description'
        db.add_column('core_product', 'programming_required_description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Product.programming_required_rating'
        db.add_column('core_product', 'programming_required_rating', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Review.programming'
        db.delete_column('core_review', 'programming')

        # Deleting field 'Review.programming_text'
        db.delete_column('core_review', 'programming_text')
    ...
    models = {
        ...
        'core.review': {
            ...
            'programming_text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'rating': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'rating_text': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'review_done': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
