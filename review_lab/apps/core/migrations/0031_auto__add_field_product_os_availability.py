...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.os_availability'
        db.add_column('core_product', 'os_availability', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.os_availability'
        db.delete_column('core_product', 'os_availability')
