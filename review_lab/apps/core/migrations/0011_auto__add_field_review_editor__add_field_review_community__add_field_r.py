...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.editor'
        db.add_column('core_review', 'editor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='editor_user', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Review.community'
        db.add_column('core_review', 'community', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Review.documentation'
        db.add_column('core_review', 'documentation', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Review.performance'
        db.add_column('core_review', 'performance', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Review.usability'
        db.add_column('core_review', 'usability', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.editor'
        db.delete_column('core_review', 'editor_id')

        # Deleting field 'Review.community'
        db.delete_column('core_review', 'community')

        # Deleting field 'Review.documentation'
        db.delete_column('core_review', 'documentation')

        # Deleting field 'Review.performance'
        db.delete_column('core_review', 'performance')

        # Deleting field 'Review.usability'
        db.delete_column('core_review', 'usability')
    ...
    models = {
        ...
        'core.review': {
            ...
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'editor_user'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'review_done': ('django.db.models.fields.DateField', [], {'null': 'True'}),
