...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductTask.rating_text'
        db.add_column('core_producttask', 'rating_text', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductTask.rating_text'
        db.delete_column('core_producttask', 'rating_text')
