...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.obsolete'
        db.add_column('core_product', 'obsolete', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.obsolete'
        db.delete_column('core_product', 'obsolete')
