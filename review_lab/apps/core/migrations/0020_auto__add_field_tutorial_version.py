...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tutorial.version'
        db.add_column('core_tutorial', 'version', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding M2M table for field os_used on 'Tutorial'
        db.create_table('core_tutorial_os_used', (
        ...
        db.create_unique('core_tutorial_os_used', ['tutorial_id', 'operatingsystem_id'])


    def backwards(self, orm):
        
        # Deleting field 'Tutorial.version'
        db.delete_column('core_tutorial', 'version')

        # Removing M2M table for field os_used on 'Tutorial'
        db.delete_table('core_tutorial_os_used')
