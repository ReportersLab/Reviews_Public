...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_task', 'difficulty', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Task.difficulty_text'
        db.add_column('core_task', 'difficulty_text', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.difficulty'
        db.delete_column('core_task', 'difficulty')

        # Deleting field 'Task.difficulty_text'
        db.delete_column('core_task', 'difficulty_text')
