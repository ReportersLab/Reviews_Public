...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Review.programming_text'
        db.alter_column('core_review', 'programming_text', self.gf('django.db.models.fields.CharField')(max_length=256))


    def backwards(self, orm):
        
        # Changing field 'Review.programming_text'
        db.alter_column('core_review', 'programming_text', self.gf('django.db.models.fields.TextField')())
