...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductTask.teaser'
        db.add_column('core_producttask', 'teaser', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductTask.teaser'
        db.delete_column('core_producttask', 'teaser')
