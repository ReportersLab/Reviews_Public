...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_tutorial', (
            ...
            ('writer_external', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tutorial_editor_user', null=True, to=orm['auth.User'])),
            ...
            ('repo_link', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ...
        # Adding M2M table for field tasks on 'Tutorial'
        db.create_table('core_tutorial_tasks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tutorial', models.ForeignKey(orm['core.tutorial'], null=False)),
            ('task', models.ForeignKey(orm['core.task'], null=False))
        ))
        db.create_unique('core_tutorial_tasks', ['tutorial_id', 'task_id'])

        # Adding field 'DocumentSet.image'
        db.add_column('core_documentset', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'Review.image'
        db.add_column('core_review', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field tasks on 'Tutorial'
        db.delete_table('core_tutorial_tasks')

        # Deleting field 'DocumentSet.image'
        db.delete_column('core_documentset', 'image')

        # Deleting field 'Review.image'
        db.delete_column('core_review', 'image')
    ...
    models = {
        ...
        'core.tutorial': {
            ...
            'writer_external': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'})
        },
        'taggit.tag': {
