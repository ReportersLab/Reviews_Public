...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.reviewer'
        db.add_column('core_review', 'reviewer', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.reviewer'
        db.delete_column('core_review', 'reviewer_id')
