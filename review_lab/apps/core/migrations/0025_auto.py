...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field operating_systems on 'Product'
        db.create_table('core_product_operating_systems', (
        ...
        db.create_unique('core_product_operating_systems', ['product_id', 'operatingsystem_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field operating_systems on 'Product'
        db.delete_table('core_product_operating_systems')
