...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.release_date'
        db.add_column('core_product', 'release_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'Review.review_done'
        db.add_column('core_review', 'review_done', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.release_date'
        db.delete_column('core_product', 'release_date')

        # Deleting field 'Review.review_done'
        db.delete_column('core_review', 'review_done')
