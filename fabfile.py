...
env.repository_url = "https://github.com/ReportersLab/Reviews_Public.git"
...
def collect_static():
    ...
    with virtualenv():
        with cd('%(repo_path)s' % env):
            run('./manage collectstatic -i grappelli/tinymce/jscripts/tiny_mce/tiny_mce.js -i grappelli/tinymce/jscripts/tiny_mce/tiny_mce_popup.js -i grappelli/tinymce_setup/tinymce_setup.js -i grappelli/tinymce/jscripts/tiny_mce/plugins/paste/blank.htm')
